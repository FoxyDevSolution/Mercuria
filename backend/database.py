...
# Usamos variables de entorno, con fallback a valor por defecto para desarrollo
# Ejemplo de URL Postgres: postgresql://user:password@localhost:5432/mercuria
SQLALCHEMY_DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/mercuria")
...
# NOTA: Este trigger necesita ser portado a PostgreSQL (PL/pgSQL)
